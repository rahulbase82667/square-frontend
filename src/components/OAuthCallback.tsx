...
//     // ✅ Extract platform ID from state or platform parameter
//     let extractedPlatformId = '';
//     if (state) {
//       const parts = state.split('_');
//       extractedPlatformId = parts.length > 1 ? parts[1] : '';
//     }
//     const finalPlatformId = platformParam || extractedPlatformId;
//     setPlatformId(finalPlatformId);
...
//       'ebay': 'eBay'
//     };
//     setPlatformName(platformMap[finalPlatformId] || 'Platform');
...
//     // ✅ Create a mock platform object (for example purposes)
//     const mockPlatform: Platform = {
//       id: finalPlatformId,
...
//         toast({
//           title: "Connection Successful",
//           description: `Successfully connected to ${platformMap[finalPlatformId]}!`,
//         });
...
//   // ✅ Handle redirection after success or failure
//   const handleContinue = () => {
//     navigate('/integrations');
//   };
  ...
  useEffect(() => {
    ...
    const processOAuth = async () => {
      try {
        ...
        if (window.opener) {
          window.opener.postMessage({ type: 'OAUTH_SUCCESS', platformId: finalPlatformId }, '*');
